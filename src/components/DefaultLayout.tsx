...
/**
 * Do not use this as a default layout for every page. Pages need to be able to control the whole
 * page layout. This hinders that. For example the study page might not want to show the navigation
 * because it focuses on the content.
 */
export function DefaultLayout(props: ParentProps) {
  return (
